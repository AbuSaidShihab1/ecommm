...
const Dashboardheader = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      window.location.href = '/super-login'; // redirect to login or home
    }
  });
};
  return (
    <header className='w-full font-poppins h-[12vh] sticky top-0 left-0 z-[100] shadow-sm xl:h-[13vh] px-[20px] md:px-[30px] py-[10px] flex bg-white justify-between  xl:justify-end items-center'>
...
>
  ...
  <div className="p-[10px] flex items-center gap-3">
    ...
    <div>
      ...
      <p className="text-[11px] lg:text-[13px] text-gray-600">Designer</p>
    </div>
  </div>
