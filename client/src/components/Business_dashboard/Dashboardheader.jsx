...
import coin_img from "../../assets/coins.png"
import setting_img from "../../assets/settings.png"
...
const Dashboardheader = () => {
  ...
  return (
    <header className='w-full font-poppins h-[12vh] sticky top-0 left-0 z-[100000000] shadow-sm xl:h-[13vh] px-[20px] md:px-[30px] py-[10px] flex bg-white justify-between  xl:justify-end items-center'>
    ...
    <div class="relative bg-white">
        ...
        {/* -------------menu---------------------- */}
           ...
           <div className='px-[20px] py-[7px] border-[1px] border-gray-200 rounded-[5px]'>
            <h2 className='flex justify-center text-[14px] text-brand_color font-[500] items-center gap-[7px]'><img src={coin_img} className='w-[25px] h-[25px]' alt="" /> {customerData?.availableCredits}</h2>
           </div>
           <div className="flex gap-4">
  {/* Notification Box */}
  <div
    onClick={() => {
      setfilter_sidebar3(true);
    }}
    className="p-[10px] rounded-[4px] border-[1px] relative border-[#eee] shadow-sm text-[20px] cursor-pointer"
  >
    <BiSolidBellRing />
    {/* Notification Badge */}
    <span className="absolute top-1 right-1 bg-orange-500 w-[10px] h-[10px] rounded-full"></span>
  </div>

  {/* Messages Box */}
  <div
    onClick={() => {
      setfilter_sidebar2(true);
    }}
    className="p-[10px] rounded-[4px] border-[1px] relative border-[#eee] shadow-sm text-[20px] cursor-pointer"
  >
    <LuMessagesSquare />
    {/* Message Badge */}
    <span className="absolute top-1 right-1 bg-green-500 w-[10px] h-[10px] rounded-full"></span>
  </div>
</div>
<div
  onClick={() => {
    setfilter_sidebar(true);
  }}
  className="p-[10px] rounded-[4px] border-[1px] border-[#eee] shadow-sm text-[20px] cursor-pointer "
>
  <img src={setting_img} alt="" className='animate-spin w-[22px]' />
</div>

            <div className='relative'>
              <img onClick={()=>{setprofile_dropdown(!profile_dropdown)}} className='w-[40px] cursor-pointer h-[40px] rounded-full' src="https://isomorphic-furyroad.s3.amazonaws.com/public/avatars/avatar-11.webp" alt="" />
         {/*------------------- profile dropdown-------------- */}
  ...
  <div className="p-[10px] flex items-center gap-3">
    ...
    />
    <div>
      <h2 className="text-[12px] lg:text-[14px] font-[500]">Albert Flores</h2>
      <p className="text-[11px] lg:text-[13px] text-gray-600">Businessman</p>
    </div>
  </div>
      ...
      <div className="p-4 space-y-4">
        {activities.map((activity) => (
          ...
          >
            ...
            {activity.title.length > 28 ?  <h2 className="text-sm font-semibold text-gray-800">
                {activity.title?.slice(0,28)}..
              </h2>:  <h2 className="text-sm font-semibold text-gray-800">
                {activity.title}
              </h2> }
