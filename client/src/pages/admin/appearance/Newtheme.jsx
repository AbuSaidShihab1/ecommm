    ...
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%]  m-auto py-[20px] xl:py-[40px] px-[10px] xl:px-[30px]'>
             <div className='w-full flex justify-between items-center'>
                   <div>
              <h1 className='text-[20px] font-[600] mb-[8px]'>New Theme</h1>
...
<SunEditor
          ...
          />
                        ...
                        <div className='w-[100%]  mb-[20px]'>
                            <label htmlFor=""className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-500'>Theme Short Description</label>
<div className='mt-[3px] 2xl:mt-[7px]'>
<SunEditor
...
<div className="mt-2">
  ...
  {/* File Upload Field */}
                  ...
                  {activeTab === "Required" && (
                 <div className="flex flex-col items-center justify-center  p-[20px] text-center text-gray-600">
    <div className="w-full text-left">
        <label className="block text-sm font-medium mb-1">Plugins</label>

        <div className="flex flex-wrap items-center gap-2 border border-gray-300 rounded px-3 py-2 focus-within:ring-2 focus-within:ring-orange-200">
          {selectedPlugins.map((plugin, index) => (
            ...
            >
              ...
              <button onClick={() => removePlugin(plugin)}>
                <IoClose className="text-orange-700 hover:text-red-500" />
              </button>
            </div>
          ))}
          ...
          <input
            ...
            value={pluginInput}
            onChange={handlerequireplugin}
            className="flex-1 min-w-[120px] border-none focus:outline-none text-sm"
          />
        </div>

        {suggestions.length > 0 && (
          <ul className="border mt-2 bg-white rounded shadow max-h-40 overflow-y-auto">
            {suggestions.map((suggestion, index) => (
              <li
                key={index}
                onClick={() => addPlugin(suggestion)}
