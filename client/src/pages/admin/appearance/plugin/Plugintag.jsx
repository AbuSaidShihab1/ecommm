...
const [data,setData] =useState( [
  {
    id: 1,
    image: "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Fcategories%2Fbags.webp&w=1920&q=75",
    name: "Women Colths",
    slug: "women-cloths",
  ...
  {
    id: 2,
    image: "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Fcategories%2Fsunglass.webp&w=1920&q=75",
  ...
  {
    id: 2,
    image: "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Fcategories%2Fwatch.webp&w=1920&q=75",
    name: "Watch",
    slug: "watch",
    description: "Stylish sunglasses for all seasons.",
    count: 20,
    createDate: "21-October-2023",
    create_time: "08:20 PM",
    createBy: "Rakib Ahammed",
    publishDate: "21-October-2023",
    publishTime: "11:00 AM",  // Added publish time
    updateby: "Anik Hossain",
    updateDate: "21-October-2023",
    update_time: "08:20 PM",
    publishBy: "Abdul Hasan",
    authorized: "Rejected",
    visibility: "Password",
    status: "Inactive",
    action: "",
  ...
  {
    id: 1,
    image: "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Fcategories%2Fsneakers.webp&w=1920&q=75",
    name: "Sneakers",
    slug: "sneakers",
  ...
  {
    id: 2,
    image: "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Fcategories%2Fchair.webp&w=1920&q=75",
    name: "Vibration Meter",
    slug: "vibration-meter",
    description: "Stylish sunglasses for all seasons.",
    count: 20,
  ...
  },
  {
    ...
    publishDate: "21-October-2023",
    publishTime: "11:00 AM",  // Added publish time
    updateby: "Rimon Ahmmed",
    updateDate: "21-October-2023",
    update_time: "08:20 PM",
    publishBy: "Shihab Moni",
    authorized: "Pending",
    visibility: "Draft",
    status: "Inactive",
    action: "",
...
const [selectedPublisher, setSelectedPublisher] = useState(null);
  ...
  const applyFilters = () => {
    ...
    const filtered = data.filter((item) => {
      ...
      const matchesSearchTerm = searchTerm ? item.name.toLowerCase().includes(searchTerm.toLowerCase()) || item.slug.toLowerCase().includes(searchTerm.toLowerCase()) || item.description.toLowerCase().includes(searchTerm.toLowerCase()) || item.createBy.toLowerCase().includes(searchTerm.toLowerCase()) || item.createDate.toLowerCase().includes(searchTerm.toLowerCase()) || item.create_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.publishBy.toLowerCase().includes(searchTerm.toLowerCase()) || item.publishDate.toLowerCase().includes(searchTerm.toLowerCase()) || item.publishTime.toLowerCase().includes(searchTerm.toLowerCase()) || item.updateby.toLowerCase().includes(searchTerm.toLowerCase()) || item.updateDate.toLowerCase().includes(searchTerm.toLowerCase()) || item.update_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.authorized.toLowerCase().includes(searchTerm.toLowerCase()) || item.visibility.toLowerCase().includes(searchTerm.toLowerCase())  || item.status.toLowerCase().includes(searchTerm.toLowerCase()) : true;
  ...
  const themes = [
    ...
    const totalPages2 = Math.ceil(themes.length / ITEMS_PER_PAGE);
 ...
 <section className='w-[100%] m-auto py-[20px]  xl:py-[40px] px-[20px] lg:px-[30px]'>
     <div className='w-full flex md:justify-between items-center  md:flex-row flex-col justify-start'>
        ...
        {/* ---------------table --------------- */}
            ...
            <NavLink to="/super-new-plugin-tag"className="w-[50%] md:w-auto ">
...
<div className="relative  sm:rounded-lg">
  ...
  <div className="relative w-full md:w-auto">
      ...
      <input
        ...
        placeholder="Search for product tag"
        value={searchTerm}
                      ...
                      />
                       <div>
                        ...
                        <div className="text-[14px] text-gray-400">
                          {row.description.length > 40 ? <p>{row.description.slice(0,40)}..</p>:<p>{row.description}</p> }
                      </div>
                    ):col.key === "totalSales" ? (
                        <div className="text-[14px] text-gray-400">
                          ${row[col.key]}
...
>
  ...
  <span className="absolute hidden group-hover:block bottom-[35px] left-1/2 transform -translate-x-1/2 bg-brand_color text-white text-xs font-medium rounded px-2 py-0.5 z-10">
    ...
    <span className="absolute left-1/2 transform -translate-x-1/2 bottom-[-5px] w-0 h-0 border-x-[5px] border-x-transparent border-t-[5px] border-brand_color"></span>
                                                 ...
                                                 <NavLink to="/super-edit-plugin-tag" className="w-[30px] h-[30px]  border border-gray-300 rounded-[5px] hover:text-brand_color flex justify-center items-center text-[15px] cursor-pointer hover:border-brand_color dark:border-gray-700 dark:hover:bg-gray-800 group relative">
                                                   <CiEdit />
                                                   <span className="absolute hidden group-hover:block bottom-[35px] left-1/2 transform -translate-x-1/2 bg-brand_color text-white text-xs font-medium rounded px-2 py-0.5 z-10">
                                                     Edit
                                                       <span className="absolute left-1/2 transform -translate-x-1/2 bottom-[-5px] w-0 h-0 border-x-[5px] border-x-transparent border-t-[5px] border-brand_color"></span>
...
{/* --------------------------------------theme-popup------------------------------ */}
{isPopupOpen && (
  <div className="fixed inset-0 z-[100000000] bg-black bg-opacity-50 flex justify-center items-center overflow-y-auto py-[100px]">
    <div className=' mt-[50vh] '>
    <div className="bg-white rounded-lg relative w-[90%] shadow-lg h-full ">
      <button 
        onClick={togglePopup}
      ...
      <section className={` font-sans bg-[#F2F4F8] `}>
   <div className="bg-white border-b-[1px] border-gray-100">
   <div className="bg-white  py-8 px-5 lg:px-[70px]   mx-auto w-full xl:max-w-[1300px]  text-gray-800 font-sans">
      {/* Breadcrumb */}
...
{/* ---------------------------product----------------- */}
 <section className="flex py-[20px]  font-sans px-5 lg:px-[70px]  mx-auto w-full xl:max-w-[1300px]  gap-[10px] flex-col-reverse lg:flex-row">
