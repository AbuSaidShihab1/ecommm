    ...
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%]  m-auto py-[20px] xl:py-[40px] px-[10px] xl:px-[30px]'>
             <div className='w-full flex justify-between items-center'>
                   <div>
              <h1 className='text-[20px] font-[600] mb-[8px]'>School Management</h1>
              ...
              >
                Edit
                           ...
                           <div className='w-[100%]  mb-[20px]'>
                            <label htmlFor=""className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-500'>Theme Description</label>
...
<SunEditor
          ...
          />
                        ...
                        <div className='w-[100%]  mb-[20px]'>
                            <label htmlFor=""className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-500'>Thene Short Description</label>
<div className='mt-[3px] 2xl:mt-[7px]'>
<SunEditor
...
/> </div>
    ...
    {activeTab === "Product" && (
        ...
        <div className="mt-2 relative">
          <label htmlFor="iconUpload" className="w-32 h-32 border-2 border-dashed border-gray-300 flex items-center justify-center rounded-md overflow-hidden cursor-pointer">
            {iconPreview ? (
          ...
          <input type="file" accept="image/*" onChange={handleIconUpload} className="hidden" id="iconUpload" />
        </div>
