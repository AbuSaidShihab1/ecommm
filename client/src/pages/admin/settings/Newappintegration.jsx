    ...
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%]  m-auto py-[20px] xl:py-[40px] px-[10px] xl:px-[30px]'>
             <div className='w-full flex justify-between items-center'>
                   <div>
              <h1 className='text-[20px] font-[600] mb-[8px]'>New App Integration</h1>
          <ul className='flex justify-center items-center gap-[10px] text-neutral-500 text-[14px] font-[500]'>
            <li>Dashboard</li>
            <li><IoIosArrowForward/></li>
            <li>Setting</li>
            <li><IoIosArrowForward/></li>
            <li>New App Integration</li>
          </ul>
                 </div>
                     {/* <div>
...
{/* File Upload Field */}
<div className="mt-2">
  <label  className="text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-600">Upload File:</label>
  <div className="flex items-center gap-4 border-[1px] border-gray-300 p-[5px] rounded-[5px] mt-[3px] 2xl:mt-[7px] mb-[10px]">
    <input
      type="file"
      id="customFile"
...
export default Newappintegration