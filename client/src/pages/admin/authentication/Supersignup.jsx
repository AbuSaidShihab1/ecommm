        ...
        <section className='w-[90%] lg:w-[45%] xl:w-[45%]  xl:pl-[30px] 2xl:pl-[70px]'>
            <div className='w-[90%] xl:w-[80%] m-auto'>
               <NavLink to="/"> <h1 className='flex justify-start items-center gap-[5px] cursor-pointer text-[14px] text-neutral-600'><IoIosArrowRoundBack className='text-[22px]'/> Back to home</h1></NavLink>
                <div className='mt-[25px] lg:mt-[20px] flex mb-[25px] lg:mb-[20px] lg:mb-[30px] justify-center lg:justify-start items-center gap-[20px]'>
                 ...
                 <div className='flex justify-center md:flex-row flex-col mt-[40px]  gap-[20px]'>
                    ...
                    {/* ------------registration form------------- */}
                       ...
                       <div className='grid grid-cols-1 md:grid-cols-2 gap-[15px]  mb-[15px]'>
                           <div>
                            <label htmlFor="name"className='text-[14px] lg:text-[16px] text-neutral-800'>First Name</label> <br />
                            <input type="text"placeholder='Enter your first name'className='px-[15px] text-[14px] outline-brand_color mt-[5px] w-full h-[50px] border-[2px] border-[#eee] rounded-[5px]' />
                            </div>  
                               <div>
                            <label htmlFor="name"className='text-[14px] lg:text-[16px] text-neutral-800'>Last Name</label> <br />
                            <input type="text"placeholder='Enter your last name'className='px-[15px] text-[14px] outline-brand_color mt-[5px] w-full h-[50px] border-[2px] border-[#eee] rounded-[5px]' />
                            </div>  
                       </div>
                            ...
                            <input type="text"placeholder='Enter your email'className='px-[15px] text-[14px] outline-brand_color mt-[5px] w-full h-[50px] border-[2px] border-[#eee] rounded-[5px]' />
                               ...
                               <div className='grid grid-cols-1 md:grid-cols-2 gap-[15px]  mb-[15px]'>
                           <div>
                            <label htmlFor="Password"className='text-[14px] lg:text-[16px] text-neutral-800'>Password</label> <br />
                            ...
                            <input type="text"placeholder='Enter your confirm password'className='px-[15px] text-[14px] outline-brand_color mt-[5px] w-full h-[50px] border-[2px] border-[#eee] rounded-[5px]' />
                            </div>  
                       </div>
                       <div className='flex justify-start mt-[10px] items-center gap-[10px]'>
                        <input type="checkbox"className='w-[15px] h-[15px] border-[1px] ' />
                        <h3 className='text-[14px] '>By signing up you have agreed to our <span className='text-indigo-500'>Terms</span> & <span className='text-indigo-500'>Privacy Policy</span></h3>
                       </div>
                       <button className='mt-[20px] mb-[20px] rounded-[5px] text-white w-full h-[50px] bg-brand_color'>Get Started</button>
                      <div className='flex'>
                        <h2 className='text-[14px] text-neutral-500'>Don’t have an account? <span className='text-black font-[600] text-[14px]'>Sign In</span></h2>
                      </div>
                       </form>
                    {/* ------------registration form------------- */}
            </div>
