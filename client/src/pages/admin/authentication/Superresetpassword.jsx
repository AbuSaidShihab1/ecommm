        ...
        <section className='w-[90%] lg:w-[45%] xl:w-[45%]   xl:pl-[30px] 2xl:pl-[70px]'>
            <div className='w-[90%] xl:w-[80%] m-auto'>
                ...
                <div className=' text-center lg:text-left w-[90%] lg:m-0 m-auto mb-[40px] '>
                     <h1 className='text-[28px] lg:text-[35px] lg:leading-[55px] font-bold mb-[20px]'>Reset your password!</h1>
                </div>
                    ...
                    {/* ------------registration form------------- */}
                       ...
                       <button className='mt-[15px] mb-[20px] rounded-[5px] text-white w-full h-[50px] bg-brand_color'>Reset Password</button>
                      <div className='flex'>
