  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <div className='w-full flex justify-between items-center'>
        <div>
              <h1 className='text-[20px] lg:text-[20px] font-[600] mb-[8px]'>Edit Customer</h1>
             ...
             {/* Profile Image Section */}
               ...
               {profileImage ? (
                 <img
                   ...
                   alt="Profile"
                   onClick={togglePopup}
                   className="w-[150px] h-[100px]  overflow-hidden border-2 border-gray-300"
                 />
               ) :""
               }
           ...
           <div className="relative  mb-[10px]">
             ...
             <div className="relative mb-[10px]  mt-[10px]">
               <div>
                 ...
                 onClick={togglePopupVisibility}
                     src={websiteIcon}
                     alt="Website Icon"
                     className="w-[150px] h-[150px] overflow-hidden border-2 border-gray-300"
                   />
                 ) : (
                   <p></p>
                 )}
             ...
             <div>
               ...
               onClick={togglePopupVisibility}
                   ...
                   alt="Portrait Logo"
                   className="w-[300px] h-[150px] overflow-hidden border-2 border-gray-300 object-cover"
                 />
               ) : (
