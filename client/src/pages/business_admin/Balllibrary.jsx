  ...
  const data = [
    {
      ...
      image:"https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Favatars%2Favatar-10.webp&w=1920&q=75",
        title: "Avatar 10 - WordPress Jetpack",
      size: "5KB",
      type: "image/webp",
      createDate:"15-Jan-2023",
      create_time: "08:20 PM",
      author: "Rakib Hossain",
      authorizeDate:"16-Jan-2023", 
      authorizedtime: "10:00 AM",
      authorizeBy: "Anik Rahman",
      mediatype:"Audios",
      updateDate:"17-Jan-2023", 
      updatetime: "02:30 PM",
      updateBy: "Rajib",
      authorized:"Rejected",
      action: "Edit",
    },
    {
      ...
      authorizeDate:"16-Jan-2023", 
      authorizedtime: "10:00 AM",
      authorizeBy: "Rakib Hossain",
      updateDate:"17-Jan-2023", 
      updatetime: "02:30 PM",
      updateBy: "Sujon Rahman",
      authorized:"Approved",
      action: "Edit",
    },
    {
    ...
    },
    {
      ...
      createDate:"15-Jan-2023",
      create_time: "08:20 PM",
      author: "Rajib Ahammed",
      authorizeDate:"16-Jan-2023", 
      mediatype:"Images",
      authorizedtime: "10:00 AM",
      authorizeBy: "Rimon Ahammed",
      updateDate:"17-Jan-2023", 
      updatetime: "02:30 PM",
...
{currentRows.length > 0 ? (
                ...
                .map((col) => (
                  ...
                  >
                   ...
                   <div className="flex justify-start items-center gap-[15px] pr-[40px] ">
                        ...
                        <div>
                           {
                            row.title.length > 20 ? <h1 className="text-[12px] lg:text-[16px] font-[500] text-black text-nowrap">{row.title.slice(0,20)}..</h1>:<h1 className="text-[12px] lg:text-[16px] font-[500] text-black text-nowrap">{row.title}</h1>
                           }
                          <p className="text-[8px] lg:text-[13px] mt-[4px] font-[500] text-orange-600">{row.size}</p>
                        </div>
                      </div>
                    )  : col.key === "authorized" ? (
                      <span
                        ...
                        <div className="text-[14px] text-gray-400">
                          {row.updatetime}
                             ...
                             <div className="flex justify-start items-center gap-[12px] relative">
                                                            ...
                                                            <div  onClick={() => setSelectedImage(row.image)} className="w-[30px] h-[30px]  border border-gray-300 rounded-[5px] hover:text-brand_color flex justify-center items-center text-[15px] cursor-pointer hover:border-brand_color dark:border-gray-700 dark:hover:bg-gray-800 group relative">
                                                              <GoEye  />
      ...
      {/* Image Modal */}
      {selectedImage && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[100000000]">
          <div className="relative bg-white p-1 rounded-lg shadow-lg">
            ...
            <img src={selectedImage} alt="Preview" className="w-[400px] rounded-md" />
          </div>
        </div>
      )}
      </table>
