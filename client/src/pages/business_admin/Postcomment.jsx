...
const [data, setData] = useState([
  {
    id: 1,
    Image:
      "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Favatars%2Favatar-14.webp&w=1920&q=75",
    name: " Abu Said Shihab",
    email: "shihabmoni177@gmail.com",
    post_img:"https://images.pexels.com/photos/159844/cellular-education-classroom-159844.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    post: "Education Post",
    comment: "This is a post about food",
    category:"Education",
    create_date: "21-October-2023",
    create_time: "10:15 AM",
    publish_date: "25-October-2023",
  ...
  },
  {
    id: 2,
    Image:
      "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Favatars%2Favatar-13.webp&w=1920&q=75",
    name: "Lim Abu Said Shihabon",
    ...
    category:"Cooking",
    create_date: "21-October-2023",
    create_time: "09:45 AM",
    publish_date: "26-October-2023",
    publish_by: " Abu Said Shihab",
    updated_time: "08:20 PM",
    updateby: "Zobaer Ahmmed",
    updateDate: "21-October-2023",
  ...
  },
  {
    id: 3,
    Image:
      "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Favatars%2Favatar-12.webp&w=1920&q=75",
    name: "Zobaer Ahmmed",
    email: "shihabmoni177@gmail.com",
    post_img:"https://images.pexels.com/photos/159844/cellular-education-classroom-159844.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    post: "Education Post",
    ...
    category:"Arts",
    create_date: "21-October-2023",
    create_time: "02:30 PM",
    publish_date: "27-October-2023",
  ...
  },
  {
    id: 4,
    Image:
      "https://isomorphic-furyroad.vercel.app/_next/image?url=https%3A%2F%2Fisomorphic-furyroad.s3.amazonaws.com%2Fpublic%2Favatars%2Favatar-11.webp&w=1920&q=75",
    name: "Zobaer Ahmmed",
    ...
    category:"Business",
    create_date: "21-October-2023",
    create_time: "01:10 PM",
    publish_date: "28-October-2023",
    publish_by: "Zobaer Ahmmed",
    updated_time: "08:20 PM",
    updateby: "Zobaer Ahmmed",
    updateDate: "21-October-2023",
...
const columns = [
 ...
 const getAuthorizedColor = (authorized) => {
    switch (authorized) {
      case 'Approved':
  ...
  const handleColumnToggle = (key) => {
    setVisibleColumns((prev) =>
      prev.includes(key)
        ...
        // --------------------type-----------
                      const [selectedOption5, setSelectedOption5] = useState('Select Type');
                     ...
                     const [hoveredItem, setHoveredItem] = useState(null); // Tracks the currently hovered item
                      ...
                      const options5 = [
                        ...
                        { label: 'Reviews', color: 'text-green-500', bgColor: 'bg-green-500' },
                        { label: 'Replies', color: 'text-orange-500', bgColor: 'bg-orange-500' },
                      ];
                      ...
                      const handleSelect5 = (option) => {
                        setSelectedOption5(option.label);
                        setIsOpen5(false);
                        ...
                        const selectedOptionData5 = options5.find(
                      (option) => option.label === selectedOption5
                    );
                         // --------------------visibility-----------
                      ...
                      const options = [
                        ...
                        { label: 'Spam', color: 'text-red-500', bgColor: 'bg-red-500' },
                      ];
  ...
  // Helper function to get unique "author" suggestions
  ...
  // Helper function to get unique "post" suggestions
  const fetchUniquePostSuggestions = (value) => {
    return [
      ...new Set(
        data
          .filter((item) =>
  ...
  const handlePostInputChange = (e) => {
    ...
    if (value) {
      setPostSuggestions(fetchUniquePostSuggestions(value));
    } else {
      setPostSuggestions([]);
    }
  };

  const handlePostSuggestionClick = (suggestion) => {
    setpostinput(suggestion);
    setPostSuggestions([]);
  };
  // -----------------publish-suggestions----------------
...
const [selectedPublisher, setSelectedPublisher] = useState(null);
  ...
  const applyFilters = () => {
    ...
    const filtered = data.filter((item) => {
      const matchesauthor = authorinput ? item.name.toLowerCase().includes(authorinput.toLowerCase()) : true;
      const matchesemail = emailinput ? item.email.toLowerCase().includes(emailinput.toLowerCase()) : true;
      const matchespost = postinput ? item.post.toLowerCase().includes(postinput.toLowerCase()) : true;
      ...
      const matchesSearchTerm = searchTerm ? item.name.toLowerCase().includes(searchTerm.toLowerCase()) || item.email.toLowerCase().includes(searchTerm.toLowerCase()) || item.post.toLowerCase().includes(searchTerm.toLowerCase()) || item.comment.toLowerCase().includes(searchTerm.toLowerCase()) || item.category.toLowerCase().includes(searchTerm.toLowerCase()) || item.create_date.toLowerCase().includes(searchTerm.toLowerCase()) || item.create_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.publish_date.toLowerCase().includes(searchTerm.toLowerCase())  || item.publish_by.toLowerCase().includes(searchTerm.toLowerCase()) || item.updated_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.type.toLowerCase().includes(searchTerm.toLowerCase()) || item.authorized.toLowerCase().includes(searchTerm.toLowerCase()) || item.status.toLowerCase().includes(searchTerm.toLowerCase()) : true;
      // Create Date filter
  ...
  useEffect(() => {
    applyFilters();
  }, [searchTerm,authorinput,emailinput,postinput,createByInput,publishByInput, updateByInput, authorized,type,visibility, status, createRange, publishRange]);
  ...
  const clear_filter_data=()=>{
    ...
    setSelectedOption5("Select Type");
 ...
 <section className='w-[100%] m-auto py-[20px]  xl:py-[40px] px-[20px] lg:px-[30px]'>
     <div className='w-full flex md:justify-between items-center  md:flex-row flex-col justify-start'>
        ...
        <div className='w-full   md:w-auto flex gap-[10px] md:m-0 mt-[15px]'>
                   <button className='w-[50%] md:w-auto px-[15px] py-[7px] text-black text-[14px] gap-[8px]  border-[1px] border-[#eee] flex justify-center items-center rounded-[5px] cursor-pointer'>
...
<div className="relative  sm:rounded-lg">
 ...
 <div className='w-full md:w-auto flex justify-center items-center gap-[10px] mt-[10px] '>
...
<section className="p-[20px] relative w-[100%] ">
    ...
    <div className="mb-[10px] relative">
      <label htmlFor="post" className="text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-neutral-600">
        Post
      </label>
      <br />
      <input
        ...
        <ul className="absolute bg-white border border-[#eee] w-full mt-[5px] rounded-[3px] shadow-md z-10">
          {postSuggestions.map((suggestion, index) => (
            <li
              key={index}
              className="px-[10px] py-[5px] cursor-pointer hover:bg-indigo-100"
              onClick={() => handlePostSuggestionClick(suggestion)}
            >
              {suggestion}
            </li>
          ))}
  ...
  <div style={{ position: "relative", width: "100%" }}>
      ...
      <div className="absolute z-10 bg-white shadow-md border-[1px] border-[#eee] w-full p-2">
        ...
        <div className="flex justify-end gap-2 mt-2">
          ...
          <button onClick={applyPublishDate} className="px-3 py-1 border rounded bg-indigo-600 text-white">Apply</button>
              ...
              <div className="mt-[10px] relative mb-[10px]">
        ...
        <div className="absolute left-0 right-0 mt-1 bg-white border border-[#ddd] rounded shadow-lg z-10">
          {filteredUpdateBy.map((updateBy) => (
            ...
            >
             ...
             <div  className='mb-[10px]'>
                <label htmlFor="name"className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-neutral-600'>Type</label><br />
                <div ref={dropdownRef5} className="relative w-full mt-[5px]">
    {/* Dropdown Button */}
    <div
    ...
    >
      <div className="flex items-center gap-2">
        <span
          className={`w-3 h-3 rounded-full ${selectedOptionData5?.bgColor}`}
        ></span>
        <span className={`font-label_weight ${selectedOptionData5?.color}`}>
          {selectedOption5}
        </span>
      </div>
      <svg
    ...
    {isOpen5 && (
      <ul
        ...
        onMouseLeave={() => setHoveredItem5(null)} // Reset hovered item when mouse leaves dropdown
      >
        {options5.map((option) => (
          <li
            key={option.label}
            onClick={() => handleSelect5(option)}
            onMouseEnter={() => setHoveredItem5(option.label)} // Set hovered item
            className={`px-4 py-2 flex items-center gap-2 font-label_weight text-label_size cursor-pointer mt-[5px] 
              ${
                hoveredItem5 === option.label
                  ? `bg-gray-100 ${option.color}` // Hover background
                  : selectedOption5 === option.label && !hoveredItem5
                      ...
                      {options3.map((option) => (
                        ...
                        >
                          ...
                          {option.label}
                                  ...
                                  {
                                                                 authorinput=="" && emailinput=="" &&  postinput=="" && updateByInput==""&&  publishByInput=="" && selectedOption=="Select Authorized" && selectedOption5=="Select Type"  && selectedOption2=="Select Visibility" && selectedOption3=="Select Status" ? "":            <button
          ...
          <tr key={rowIndex}>
              {columns
                ...
                .map((col) => (
                  ...
                  >
                    {col.key === "Image" ? (
                  <div className='flex justify-start items-center gap-[10px] pr-[40px]'>
                        <img
                        src={row[col.key]}
                        alt="Row"
                      ...
                      />
                  <div>
                         {row.name.length > 30 ?       <p className="font-[600] text-black text-[15px] text-nowrap">
                            {row.name.slice(0,30)}..
        ...
        
              {
                row.email.length > 35 ?    <p className="font-[400] text-gray-500 text-nowrap">
                      ...
                      <div className='flex px-[50px] justify-center gap-[8px]'>
                          <img className='w-[50px] h-[50px] rounded-[5px]' src={row.post_img} alt="" />
                         <div>
                         {row.post.length > 40 ? (
                          <p className="text-nowrap text-[14px] text-black font-[500]">{row.post.slice(0, 40)}...</p>
                        ) : (
                          <p className="text-nowrap font-[500] text-black">{row.post}</p>
                        )}
                        <p className="text-[12px] text-gray-600 ">{row.category}</p>
                         </div>
                      </div>
                    )  : col.key === "authorized" ? (
                      <span
                        ...
                        <div className="text-[14px] text-gray-400">
                          ...
                          <div className="flex justify-start items-center gap-[12px] relative">
                                     ...
                                     <span className="absolute left-1/2 transform -translate-x-1/2 bottom-[-5px] w-0 h-0 border-x-[5px] border-x-transparent border-t-[5px] border-brand_color"></span>
                                                   ...
                                                   <NavLink to="/contents/edit-post-content-comment"className="w-[50%] md:w-auto ">
                                                   <div className="w-[30px] h-[30px]  border border-gray-300 rounded-[5px] hover:text-brand_color flex justify-center items-center text-[15px] cursor-pointer hover:border-brand_color dark:border-gray-700 dark:hover:bg-gray-800 group relative">
                                   <CiEdit />
                                   <span className="absolute hidden group-hover:block bottom-[35px] left-1/2 transform -translate-x-1/2 bg-brand_color text-white text-xs font-medium rounded px-2 py-0.5 z-10">
                                     Edit
