              ...
              {item}
                         ...
                         <div className='w-full flex gap-[10px] lg:gap-[30px] mb-[10px] '>
                          <div className='w-[100%]'>
                            ...
                            <input type="text"placeholder='Username' className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"/>
                        </div>
                         ...
                         <div className='w-full flex gap-[10px] lg:gap-[30px] mb-[10px] '>
                          <div className='w-[100%]'>
                            ...
                            <input type="Email"placeholder='Email' className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"/>
                        </div>
                         ...
                         <div className='w-full flex gap-[10px] lg:gap-[30px] mb-[10px] '>
                          <div className='w-[100%]'>
                            ...
                            <input type="number"placeholder='Phone' className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"/>
                        </div>
                       ...
                       <div className='w-full flex gap-[10px] lg:gap-[30px] mb-[10px]  lg:flex-row flex-col'>
                         ...
                         <div className='w-[100%] lg:w-[50%]'>
                            ...
                            <input type="password"placeholder='Password' className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"/>
                        </div>
                        <div className='w-[100%] lg:w-[50%]'>
                            ...
                            <input type="text"placeholder='Confirm Password' className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"/>
                        </div>
                    </div>
