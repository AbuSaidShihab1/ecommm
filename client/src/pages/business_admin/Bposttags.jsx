      ...
      return prev;
           ...
           // -------------authorized list --------------
                    ...
                    // --------------------status-----------
                      ...
                      // Helper function to get unique "create_by" suggestions
...
const [selectedPublisher, setSelectedPublisher] = useState(null);
  ...
  useEffect(() => {
    applyFilters();
  }, [searchTerm, createByInput, publishByInput, updateByInput, authorized, visibility, status, createRange, publishRange]);
 ...
 <section className='w-[100%] m-auto py-[20px]  xl:py-[40px] px-[20px] lg:px-[30px]'>
     <div className='w-full flex md:justify-between items-center  md:flex-row flex-col justify-start'>
        <div className='w-full md:w-auto'>
              <h1 className='text-[20px] font-[600] mb-[8px]'>Post Tag List</h1>
        ...
        {/* ---------------table --------------- */}
           <div className='w-full   md:w-auto flex gap-[10px] md:m-0 mt-[15px]'>
            ...
            <NavLink to="/contents/new-post-content-tag"className="w-[50%] md:w-auto ">
 ...
 <section className="p-[20px] relative w-[100%] ">
  ...
  <div style={{ position: "relative", width: "100%" }}>
    ...
    {showCreateCalendar && (
      ...
      <label htmlFor="create_by" className="text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-neutral-600">
        Create By
      </label>
      <br />
      <input
