 ...
 {!showSetupForm ? (
   <div>
     ...
     <div className="border  bg-white">
       <div className="grid grid-cols-5 font-semibold text-gray-700 border-b">
         <div className="col-span-2 py-3 px-4">Method</div>
         <div className="py-3 px-4">Enabled</div>
         <div className="py-3 px-4">Description</div>
         <div className="py-3 px-4"></div>
       </div>
       {methods.map((method, index) => (
         <div key={index} className="grid grid-cols-5 items-center border-b hover:bg-gray-50">
           <div className="col-span-2 flex items-center py-4 px-4 space-x-2">
             <FaBars className="text-gray-500" />
             <button disabled className="text-gray-300">
               <FaAngleUp />
             </button>
             <button onClick={() => toggleMethodName(index)} className="text-gray-500">
               <FaAngleDown />
             </button>
           ...
           <div className="py-4 px-4">
             <button
               className={`relative w-12 h-6 rounded-full ${
                 method.enabled ? 'bg-green-500' : 'bg-red-500'
               }`}
           ...
           <div className="py-4 px-4 text-sm text-gray-700">
             {method.description}
           </div>
           <div className="py-4 px-4">
             <button
               className="text-brand_color text-[14px] border border-brand_color px-3 py-1 rounded hover:bg-orange-100"
     ...
     <button className="px-6 py-2 bg-brand_color mt-[20px] text-white rounded-[2px] text-sm hover:bg-brand_color"
     >
       Save changes
     </button>
   </div>
