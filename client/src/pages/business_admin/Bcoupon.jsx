...
const [selectedPublisher, setSelectedPublisher] = useState(null);
  ...
  const applyFilters = () => {
    ...
    const filtered = data.filter((item) => {
      ...
      const matchesSearchTerm = searchTerm ? item.coupon.toLowerCase().includes(searchTerm.toLowerCase()) || item.description.toLowerCase().includes(searchTerm.toLowerCase()) || item.type.toLowerCase().includes(searchTerm.toLowerCase()) || item.startdate.toLowerCase().includes(searchTerm.toLowerCase()) || item.start_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.expirydate.toLowerCase().includes(searchTerm.toLowerCase()) || item.expire_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.createdate.toLowerCase().includes(searchTerm.toLowerCase())  || item.create_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.updateby.toLowerCase().includes(searchTerm.toLowerCase()) || item.createby.toLowerCase().includes(searchTerm.toLowerCase()) || item.update_time.toLowerCase().includes(searchTerm.toLowerCase()) || item.publishdate.toLowerCase().includes(searchTerm.toLowerCase()) || item.publish_time.toLowerCase().includes(searchTerm.toLowerCase())  || item.authorized.toLowerCase().includes(searchTerm.toLowerCase())  || item.type.toLowerCase().includes(searchTerm.toLowerCase())  || item.status.toLowerCase().includes(searchTerm.toLowerCase()) : true;
      // Create Date filter
 ...
 <section className='w-[100%] m-auto py-[20px]  xl:py-[40px] px-[20px] lg:px-[30px]'>
     <div className='w-full flex md:justify-between items-center  md:flex-row flex-col justify-start'>
       ...
       <div className='w-full   md:w-auto flex gap-[10px] md:m-0 mt-[15px]'>
        ...
        <NavLink to="/products/new-product-coupon"className="w-[50%] md:w-auto ">
