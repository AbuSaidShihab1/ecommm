...
const toggleBrandChildCategory = (parent, subcategory, child) => {
  ...
  const tabs = [
    ...
    { name: "Product", icon: FaLink },
    { name: "Attributes", icon: FaTag },
    { name: "360 Viewer", icon: GiAutoRepair },
    ...
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%]  m-auto py-[20px] xl:py-[40px] px-[10px] xl:px-[30px]'>
             <div className='w-full flex justify-between items-center'>
                   <div>
              <h1 className='text-[20px] font-[600] mb-[8px]'>New Product</h1>
              ...
              >
                Edit
                           ...
                           <div className='w-[100%]  mb-[20px]'>
                            <label htmlFor=""className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-500'>Product Description</label>
...
<SunEditor
          ...
          />
                        ...
                        <div className='w-[100%]  mb-[20px]'>
                            <label htmlFor=""className='text-label_size 2xl:text-[16px] font-label_weight 2xl:font-[500] text-gray-500'>Product Short Description</label>
<div className='mt-[3px] 2xl:mt-[7px]'>
<SunEditor
      ...
      <div className="flex items-center justify-between p-3 border-b border-gray-200">
        <div className="flex items-center space-x-4">
          <label className="text-sm font-medium text-gray-700">Product Data:</label>
          <select
        ...
        <div className="flex items-center space-x-4">
          {productType === "Simple product" && (
            <>
              <label className="text-sm font-medium text-gray-700">Virtual</label>
...
/> </div>
    ...
    {activeTab === "Product" && (
             ...
             className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]"
                    ...
                    />
                    <FaInfoCircle className="absolute right-3 top-[43%] text-gray-400" />
                  </div>
                </div>
              ...
              {activeTab === "Attributes" && (
                   ...
                   <div className="flex items-center justify-start gap-[10px]">
                     <select className="border rounded p-2 w-2/2">
                       <option>Custom product attribute</option>
                     </select>
                     <button className="bg-brand_color text-white text-[14px] p-2 rounded flex items-center">
                       <FaPlus className="mr-1" /> Add
                     </button>
                   </div>
                   <div className="mt-4 border relative">
                     <div className="flex justify-between  border-b-[1px] p-[10px] items-center">
                       <span className='font-[500]'>Color</span>
                       <div className="flex items-center gap-2">
                         <button onClick={toggleExpand} className="text-gray-600">
                           {expanded ? <FiChevronUp /> : <FiChevronDown />}
                         </button>
                         <button className="text-red-500" onClick={() => setValues([])}>
                           Remove
                         </button>
                       </div>
                     </div>
                     {expanded && (
                       <div className=" p-2">
                         ...
                         <input
                           ...
                           readOnly
                         /> */}
                         <label className="block mt-2">Value(s):</label>
                         <div className="border  mt-1 p-2 min-h-[100px] flex flex-wrap justify-start gap-2">
                           {values.map((val, idx) => (
                             <div
                               key={idx}
                               className="bg-gray-200 px-2 py-1 rounded flex items-center h-full"
                             >
                               {val}
                               <button
                           ...
                           <input
                             ...
                             className="border-none p-1 rounded outline-none h-full flex-grow"
                             placeholder=""
                           />
                         </div>
                         <div className="mt-2 flex gap-2  justify-between items-center">
                       <div className='flex justify-between items-center gap-2'>
                       <button className="border p-2 border-brand_color text-brand_color  text-[14px] rounded" onClick={selectAll}>
                             Select all
                           </button>
                           <button className="border p-2 border-brand_color text-brand_color  text-[14px] rounded" onClick={selectNone}>
                             Select none
                           </button>
                       </div>
                       <button className="border p-2 border-brand_color text-brand_color  text-[14px] rounded" onClick={selectNone}>
                   ...
                   <button className="bg-brand_color text-[14px] text-white p-2  mt-4 ">
                     Save attributes
                   </button>
                 </div>
              )}
             ...
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] mb-[10px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter SKU" />
             
             <label className="block text-sm font-medium text-gray-700">Model:</label>
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] mb-[10px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter Model" />
             
             <label className="block text-sm font-medium text-gray-700">Brand:</label>
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] mb-[10px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter Brand" />
             
             <label className="block text-sm font-medium text-gray-700">Origin:</label>
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] mb-[10px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter Origin" />
             
             <label className="block text-sm font-medium text-gray-700">Warranty:</label>
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] mb-[10px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter Warranty" />
             
             {/* GTIN, UPC, EAN, or ISBN */}
             <label className="block text-sm font-medium text-gray-700 mt-2">GTIN, UPC, EAN, or ISBN:</label>
             <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter identifier" />
             
             {/* Stock Management Checkbox */}
             <div className="flex items-center mt-4">
               <input type="checkbox" id="track_stock" className="w-4 h-4 mr-2" checked={trackStock} onChange={() => setTrackStock(!trackStock)} />
               <label htmlFor="track_stock" className="text-sm font-medium text-gray-700">Track stock quantity for this product</label>
             </div>
             ...
             {trackStock && (
               <div className="mt-4">
                 ...
                 <input type="number" className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter quantity" />
                 
                 <label className="block text-sm font-medium text-gray-700 mt-2">Allow backorders?</label>
                 <div className="flex items-center space-x-4 mt-[5px]">
                   <label className="flex items-center">
                     <input type="radio" name="backorder" className="w-4 h-4 mr-2" /> Do not allow
                   </label>
                   <label className="flex items-center">
                     <input type="radio" name="backorder" className="w-4 h-4 mr-2" /> Allow, but notify customer
                   </label>
                   <label className="flex items-center">
                     <input type="radio" name="backorder" className="w-4 h-4 mr-2" /> Allow
                   </label>
                 </div>
                 
                 <label className="block text-sm font-medium text-gray-700 mt-2">Low stock threshold:</label>
                 <input type="number" className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Enter threshold" />
               </div>
             )}
             
             {/* Stock Status */}
             <label className="block text-sm font-medium text-gray-700 mt-[14px] 2xl:mt-[20px]">Stock status:</label>
             <div className="flex items-center space-x-4 mb-4 mt-[5px]">
               <label className="flex items-center">
                 <input type="radio" name="stock_status" className="w-4 h-4 mr-2" /> In stock
               </label>
               <label className="flex items-center">
                 <input type="radio" name="stock_status" className="w-4 h-4 mr-2" /> Out of stock
               </label>
               <label className="flex items-center">
                 <input type="radio" name="stock_status" className="w-4 h-4 mr-2" /> On backorder
               </label>
             </div>
             
             {/* Sold Individually Checkbox */}
             <div className="flex items-center">
               <input type="checkbox" id="sold_individually" className="w-4 h-4 mr-2" />
               <label htmlFor="sold_individually" className="text-sm font-medium text-gray-700">Limit purchases to 1 item per order</label>
             </div>
           </div>
              )}
     {activeTab === "360 Viewer" && (
             <div className='p-[10px]'>
 <h2 className="text-[15px] font-[500] mb-4">360° Image View</h2>
      <div className="flex gap-2 items-center">
        {images.map((image, index) => (
          <div key={index} className="relative">
            ...
            />
            <button
              className="absolute -top-2 -right-2 bg-white rounded-full p-1 text-xs shadow-md"
        ...
        <label className="cursor-pointer border p-4 rounded-lg flex items-center justify-center w-20 h-20">
          <FaPlus className="text-gray-500 text-[22px] 2xl:text-[25px]" />
          <input
            type="file"
            accept="image/*"
            multiple
          ...
          />
              ...
              {activeTab === "Variations" && (
                 <div className="flex flex-col items-center justify-center h-[200px] p-[20px] text-center text-gray-600">
                 ...
                 <div className="p-4 ">
                 <div className="mb-2">
                   <label className="block text-sm font-medium">Purchase note</label>
                   <textarea className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] border-[1px] border-[#eee] p-[12px]"></textarea>
                 </div>
                 <div className="mb-4">
                   <label className="block text-sm font-medium">Menu order</label>
                   <div className="flex items-center gap-2">
                     <input type="number" className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" />
    ...
    <input type="text" className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="0" />
    
    {/* Dimensions */}
    <label className="block text-sm font-medium text-gray-700 mt-2">Dimensions (cm):</label>
    <div className="flex space-x-2 mb-4">
      <input type="text" className="w-1/3 mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Length" />
      <input type="text" className="w-1/3 mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Width" />
      <input type="text" className="w-1/3 mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] p-[12px]" placeholder="Height" />
    </div>
    
    {/* Shipping Class */}
    <label className="block text-sm font-medium text-gray-700 ">Shipping class:</label>
    <select className="w-full mt-[3px] 2xl:mt-[7px] rounded-[5px] placeholder-gray-700 outline-brand_color text-input_text 2xl:text-[15px] h-input_height 2xl:h-[45px] border-[1px] border-[#eee] px-[12px]">
 ...
 {brands.map((brand) => (
  <li key={brand.name}>
    <label className="flex items-center gap-2 cursor-pointer">
      ...
      />
      <span
        className={`w-4 h-4 2xl:w-4 2xl:h-4 rounded-sm border ${checkedBrands[brand.name] ? 'bg-brand_color border-brand_color' : 'bg-white border-neutral-600'} flex items-center justify-center`}
      >
        {checkedBrands[brand.name] && (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="w-5 h-5" // Increased size of the checkmark
          >
            <path d="M5 13l4 4L19 7" />
          </svg>
        )}
      </span>
      <span className="text-[16px] text-neutral-600"> {/* Same font size and color */}
        {brand.name}
      </span>
    </label>
    <ul className="ml-6 mt-2 space-y-2">
      {brand.subcategories.map((subcategory) => (
        <li key={subcategory.name}>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="hidden" // Hides the default checkbox
              checked={checkedBrands[subcategory.name] || false}
              onChange={() =>
                handleBrandCheckboxChange(brand.name, subcategory.name)
              }
            />
            <span
              className={`w-4 h-4 2xl:w-4 2xl:h-4 rounded-sm border ${checkedBrands[subcategory.name] ? 'bg-brand_color border-brand_color' : 'bg-white border-neutral-600'} flex items-center justify-center`}
            >
              {checkedBrands[subcategory.name] && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <li key={child}>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      className="hidden" // Hides the default checkbox
                      checked={checkedBrands[child] || false}
                      onChange={() =>
                    ...
                    />
                    <span
                      className={`w-4 h-4 2xl:w-4 2xl:h-4 rounded-sm border ${checkedBrands[child] ? 'bg-brand_color border-brand_color' : 'bg-white border-neutral-600'} flex items-center justify-center`}
                    >
                      {checkedBrands[child] && (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
